...
EMSCRIPTEN_BINDINGS(occt_wasm) {
    ...
    class_<OcctKernel>("OcctKernel")
        ...
        .function("chamferOnFaces", &OcctKernel::chamferOnFaces)
        ...
        .function("filletLaw", &OcctKernel::filletLaw)
        ...
        .function("xcafAddAssembly", &OcctKernel::xcafAddAssembly)
        ...
        .function("xcafGetReferredLabel", &OcctKernel::xcafGetReferredLabel)
        .function("xcafGetLabelLocation", &OcctKernel::xcafGetLabelLocation)
        .function("xcafGetSubShapeLabels", &OcctKernel::xcafGetSubShapeLabels)
