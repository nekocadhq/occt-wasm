...
export interface OcctRawKernel {
    ...
    makeConicalHelixWire(px: number, py: number, pz: number, dx: number, dy: number, dz: number, pitch: number, height: number, radius: number, semiAngle: number, leftHanded: boolean): number;
